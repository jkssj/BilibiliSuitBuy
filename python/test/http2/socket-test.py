# https://python-hyper.org/projects/hyper-h2/en/stable/plain-sockets-example.html
...
s = socket.create_connection(adder)
s = ctx.wrap_socket(s, server_hostname=adder[0])
